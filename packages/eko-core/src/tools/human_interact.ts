...
request_help: Request assistance from the user; for instance, when an operation is blocked, the AI can ask the user for help, For example, password input required, sudo permission needed, configuration file editing, or manual intervention for system operations.`;
    this.parameters = {
      type: "object",
      properties: {
        interactType: {
